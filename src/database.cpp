/**
 * @file database.cpp
 * @brief Opens the SQLite database files and loads MLB team and stadium distance data into vectors.
 */
...
// Open both SQLite databases and load all data into vectors
