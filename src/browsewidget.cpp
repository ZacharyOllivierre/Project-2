/**
 * @file browsewidget.cpp
 * @brief Implements the browse table, filter dropdowns, sorting options, and row display logic.
 */
...
// Filter and sort the table before displaying rows
...
// Adds row to table
// Add one MLB team row to the table widget
