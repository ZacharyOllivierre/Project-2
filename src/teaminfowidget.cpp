/**
 * @file teaminfowidget.cpp
 * @brief Displays selected team information, loads souvenirs from the database, and handles souvenir purchases.
 */
...
// Display all selected team information on the screen
...
// Reload souvenirs after admin edits the database
...
// Build the right-side information and souvenir panel
